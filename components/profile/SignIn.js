...
const SignIn = ({ onChangeHandler, setUiState, signIn }) => {
      ...
      <div className="shadow-lg px-10 md:px-20 py-10">
        ...
        <div>
          <div className="grid grid-cols-2 my-6">
            ...
            <div className="relative col-span-1 flex flex-col my-2 ml-5">
              ...
              <Link href="#">
                <a
                  onClick={() => setUiState("forgotPW")}
                  className="text-sm text-indigo-600 font-medium text-right max-w-max"
                >

...
const ConfirmSignUp = ({ onChangeHandler, setUiState, confirmSignUp }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col justify-center items-center min-h-screen">
      <div className="shadow-lg px-10 md:px-20 py-10">
        <p className="text-2xl font-bold">Confirmation code has been sent!</p>
        <div>
          <form className="grid grid-cols-2 my-6">
            <div className="relative col-span-2 flex flex-col my-2 ml-5">
              <label className="text-sm font-semibold">Confirmation code</label>
              <input
